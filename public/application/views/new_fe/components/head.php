...
<head>
    ...
    <title><?= isset($title) ? $title : 'BAPENDA' ?></title>

    <meta name="keywords" content="<?= isset($meta_keywords) ? $meta_keywords : 'BAPENDA, Badan Pendapatan Daerah, Purwakarta, pajak daerah, retribusi, pelayanan pajak, informasi pajak Purwakarta, pendapatan daerah, e-pajak, sistem informasi pajak, Purwakarta digital' ?>" />
    <meta name="description" content="<?= isset($meta_description) ? $meta_description : 'Situs resmi Badan Pendapatan Daerah (BAPENDA) Kabupaten Purwakarta. Temukan informasi pajak daerah, layanan retribusi, serta berbagai inovasi digital dalam pengelolaan pendapatan daerah.' ?>" />
