...
<body class="min-h-screen min-w-screen overflow-x-hidden relative bg-white">
    ...
    <div class="relative min-h-screen w-full bg-cover bg-center max-md:bg-[-90px_center] overflow-hidden" style="background-image: url('<?= base_url('assets/beranda/new-bg.png') ?>');">
        <!-- Layer overlay biru -->
        ...
        <div class="relative z-10 min-h-screen flex flex-col p-[1.556vw] max-md:p-[2.051vw]">
            <div class="flex items-center justify-between max-md:flex-col max-md:items-start max-md:gap-3">
                ...
                <h1 class="text-[4.669vw] max-md:text-[12.308vw] max-md:w-full text-[#EA6D0D] uppercase krona-one leading-none text-right">
                    Beranda
                </h1>
            </div>
            ...
            <div class="flex-1 flex items-center w-full">
                <div class="w-full px-[10.992vw] max-md:px-0">
                    <h2 class="text-(--yellow-color) text-[3.891vw] geologica leading-none max-md:text-[10.256vw] max-md:text-justify">
                    ...
                    <p class="text-[0.973vw] text-white mt-[0.584vw] open-sans max-md:text-[3.59vw] max-md:mt-[4.103vw] max-md:text-center">
                        Pengelola Pendapatan yang Transparant
                    </p>

                    <div class="w-fit mx-auto grid grid-cols-3 max-md:grid-rows-1 gap-[1.17vw] max-md:gap-[4.103vw] mt-[2vw] max-md:mt-[8.205vw]">
                        <!-- Menu 1 -->
                        <div class="relative border border-white flex items-center rounded-xs justify-center bg-[#EA6D0D] p-[0.49vw] pl-[2.5vw] text-white open-sans text-[0.681vw] max-md:p-[1.538vw] max-md:pl-[9vw] max-md:text-[3.59vw]">
                            <img src="<?= base_url('assets/beranda/check-list.svg') ?>" alt="" class="absolute left-0 h-full w-[1.8vw] max-md:w-[7vw] shrink-0">
                            <span>PBB-P2</span>
                        </div>
