                            ...
                            <div class="rd-navbar-right rd-navbar-nav-wrap">
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item active"><a class="rd-nav-link" href="<?= site_url('kritik-saran') ?>">Kritik & Saran</a>
                                        </li>
        ...
        <section class="section">
            <div class="container section-md">
                <h3 class="box-icon-megan-title"><a href="#">
                        <hr class="team_hr team_hr_left hr_gray" />Kritik & Saran
                        <hr class="team_hr team_hr_left hr_gray" />
                    </a></h3>
                    <div id="alertContainer"></div>
                <form id="form_input">
                    <div class="form-grup">
                      <label for="nama_lengkap">Nama <span style="color:red">*</span> </label>
                      <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" required>
                    </div>
                    <div class="form-grup">
                      <label for="no_hp">No Handphone </label>
                      <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="opsional" pattern="[0-9]+" minlength="10" inputmode="numeric"z>
                    </div>
                    <div class="form-grup">
                      <label for="email">Email </label>
                      <input type="email" name="email" id="email" class="form-control" placeholder="opsional">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat </label>
                        <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="opsional"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="kritik">Kritik <span style="color:red">*</span></label>
                        <textarea class="form-control" id="kritik" name="kritik" rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="saran">Saran <span style="color:red">*</span></label>
                        <textarea class="form-control" id="saran" name="saran" rows="3" required></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" id="btn_save">Kirim</button>
                </form>
            </div>
...
<script>
    $('#form_input').submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo site_url('api/kritik-saran/store')?>",
            method: "POST",
            data: formData1,
            contentType: false,
            cache: false,
