...
((t, e) => {
    ...
    function q(t, e, i, n) {
        ...
        return (
            I(Event) && I(CustomEvent)
                ? (o = new CustomEvent(
                      e,
                      P({ bubbles: !0, cancelable: !0, detail: i }, n)
                  ))
    ...
    var kt =
        e.navigator &&
        /Version\/\d+(\.\d+)+?\s+Safari/i.test(e.navigator.userAgent);
    function zt(i, t, e) {
        var n,
    ...
    function Et(t, e) {
        var i = t.pageX,
            t = t.pageY,
            n = { endX: i, endY: t };
        return e ? n : P({ timeStamp: Date.now(), startX: i, startY: t }, n);
    }
    var Dt,
        i = {
            render: function () {
            ...
            rotateTo: function (t) {
                ...
                if (
                    ...
                    if (
                        ...
                        !1 === q(i, "rotate", { degree: t, oldDegree: s }))
                    )
                        return this;
                    (o.rotate = t),
                        (this.rotating = !0),
                ...
                return (
                    this.isShown &&
                        ...
                        !1 !== q(t, "play") &&
                            ...
                            0 < o.interval &&
                            ((e = function () {
                                clearTimeout(n.playing.timeout),
                                    M(r[h], u),
                                    R(r[(h = 0 <= --h ? h : l - 1)], u),
                                    (n.playing.timeout = setTimeout(
                                        e,
                                        o.interval
                                    ));
                            }),
                        ...
                        (this.playing = {
                            prev: e,
                            next: i,
                            timeout: setTimeout(i, o.interval),
                        }),
                    this
                );
            },
